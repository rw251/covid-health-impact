...
```{r fig1, fig.width = 6.268, fig.cap='Figure S9 - First diagnosis of type 2 diabetes each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
initialiseTable()
...
```{r fig2, fig.width = 6.268, fig.cap='Figure S10 - First diagnosis of type 2 diabetes each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData, 'Type 2 Diabetes', yLabel='Frequency of first diagnosis', justLastTwoYears = TRUE)
```

```{r fig3, fig.width = 6.268, fig.cap='Figure S11 - First prescription of metformin each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig4, fig.width = 6.268, fig.cap='Figure S12 - First prescription of metformin each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'Metformin', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig5, fig.width = 6.268, fig.cap='Figure S13 - First diagnosis of circulatory system disease each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig6, fig.width = 6.268, fig.cap='Figure S14 - First diagnosis of circulatory system disease each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'Circulatory System Diseases', yLabel='Frequency of first diagnosis', justLastTwoYears = TRUE)
```

```{r fig7, fig.width = 6.268, fig.cap='Figure S15 - First prescription of aspirin 75mg each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig8, fig.width = 6.268, fig.cap='Figure S16 - First prescription of aspirin 75mg each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'Aspirin 75mg', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig9, fig.width = 6.268, fig.cap='Figure S17 - First prescription of a dihydropyridine calcium channel blocker (CCB) each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig10, fig.width = 6.268, fig.cap='Figure S18 - First prescription of dihydropyridine calcium channel blocker (CCB)  each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'CCB', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig11, fig.width = 6.268, fig.cap='Figure S19 - First prescription of an angiotensin-converting enzyme inhibitor (ACEI) each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig12, fig.width = 6.268, fig.cap='Figure S20 - First prescription of an angiotensin-converting enzyme inhibitor (ACEI) each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'ACE Inhibitors', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig13, fig.width = 6.268, fig.cap='Figure S21 - First prescription of clopidogrel each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig14, fig.width = 6.268, fig.cap='Figure S22 - First prescription of clopidogrel each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'Clopidogrel', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig15, fig.width = 6.268, fig.cap='Figure S23 - First diagnosis of a common mental health problem each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig16, fig.width = 6.268, fig.cap='Figure S24 - First diagnosis of a common mental health problem each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'Common mental health problems', yLabel='Frequency of first diagnosis', justLastTwoYears = TRUE)
```

```{r fig17, fig.width = 6.268, fig.cap='Figure S25 - First prescription of a selective serotonin reuptake inhibitor (SSRI) each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig18, fig.width = 6.268, fig.cap='Figure S26 - First prescription of selective serotonin reuptake inhibitor (SSRI) each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
plotChart(allData,'SSRI', yLabel='Frequency of first prescription', justLastTwoYears = TRUE)
```

```{r fig19, fig.width = 6.268, fig.cap='Figure S27 - First diagnosis of malignant cancer each month 2010-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
```{r fig20, fig.width = 6.268, fig.cap='Figure S28 - First diagnosis of malignant cancer each month 2019-present. Predicted line based on negative binomial regression model using data up to and including Feb 2020', echo=FALSE}
...
kable(outputTableAll, row.names = FALSE, caption="Table 1: The expected number of first diagnoses or first prescriptions as generated from the negative binomial regression models, and the number of first diagnoses and first prescriptions observed in the data, for March to May 2020. ACEIs - angiotensin-converting enzyme inhibitors, CCBs - calcium channel blockers, SSRIs - selective serotonin reuptake inhibitors.")
```
